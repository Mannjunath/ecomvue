            ...
            <div class="row">
                <div class="col-md-6">
                    <ul>
                        ...
                        <li><b>List Price: </b><span>{{ items.pricingWarehouse.currency }} {{ items.pricingWarehouse.listPrice }}</span></li>
                        <li><b>Your Price: </b><span>{{ items.pricingWarehouse.currency }}{{ items.pricingWarehouse.costPrice }}</span></li>
                    </ul>
                </div>
                <div class="col-md-6">
